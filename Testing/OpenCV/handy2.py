...
while (1):
    ...
    if version is '3':
        image, contours, hierarchy = cv2.findContours(fgmask.copy(), \
                                                      cv2.RETR_TREE, cv2.CHAIN_APPROX_NONE)
    elif version is '2':
        contours, hierarchy = cv2.findContours(fgmask.copy(), cv2.RETR_TREE, \
    ...
    if count_defects == 1:
        cv2.putText(frame, "I am Vipul", (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 2, 2)
